...
| **Rodríguez, Of Conformity to the Will of God** | `data/rodriguez.json` | English: public domain (US, 1861 Dublin publication of the anonymous translation from Régnier-Desmarais's French); editorial repair and paragraph numbering: [CC0 1.0](LICENSE-DATA) |
| **Caussade (attributed), Abandonment to Divine Providence** | `data/caussade.json` | English: public domain (US, 1887 Benziger publication of Ella J. McMahon's translation); editorial repair and paragraph numbering: [CC0 1.0](LICENSE-DATA) |
| **Acosta, The Natural and Moral History of the Indies** | `data/acosta.json` | English: public domain (Grimston's 1604 translation in the Hakluyt Society printing of 1880); selection, editorial repair and paragraph numbering: [CC0 1.0](LICENSE-DATA) |
| **Ricci/Trigault in Purchas his Pilgrimes** | `data/ricci.json` | English: public domain (Purchas's 1625 digest in the MacLehose printing of 1906); selection, editorial repair and paragraph numbering: [CC0 1.0](LICENSE-DATA) |
...
| **The Reductions of Paraguay** | `data/paraguay.json` | English: public domain (Muratori in the London printing of 1759); Spanish: public domain (Montoya 1639, reprint 1892); selection, editorial repair, paragraph numbering and the working translation of the Montoya passages: [CC0 1.0](LICENSE-DATA) |
| **Kircher, Musurgia universalis (selections)** | `data/musurgia.json`, `assets/musurgia/*` | Latin and Iconismus III: public domain (Rome 1650 printing; faithful reproduction of a public-domain 2-D work adds nothing licensable); selection, editorial repair, paragraph numbering and the English working translation: [CC0 1.0](LICENSE-DATA) |
| **Pozzo, Perspectiva (selections)** | `data/pozzo.json`, `assets/pozzo/*` | Latin, the 1707 English and Sturt's plates: public domain (London 1707 printing; faithful reproduction of a public-domain 2-D work adds nothing licensable); selection, editorial repair, eye-transcription of the damaged pages and paragraph numbering: [CC0 1.0](LICENSE-DATA) |
| **Regimini militantis Ecclesiae — the founding bull** | `data/formula.json` | Latin: public domain (bull of 1540; Florence printing of 1892); English working translation and paragraph numbering: [CC0 1.0](LICENSE-DATA) |
...
| **Limpieza de sangre module** | `data/limpieza.json` | Latin: public domain (decrees in the Florence printing of 1893); Spanish: public domain (Ribadeneira's memorial in the MHSI printing of 1923, pre-1930); editorial repair, paragraph numbering and the English working translations: [CC0 1.0](LICENSE-DATA) |
| **Molina on the slave trade** | `data/servitus.json` | Latin: public domain (Venice printing of 1594; eye-transcription adds nothing licensable); selection, paragraph numbering and the English working translation: [CC0 1.0](LICENSE-DATA) |
| **Cenodoxus (selections)** | `data/cenodoxus.json` | Latin: public domain (Munich printing of 1666; the MDZ's NoC-NC claim on the digitisation noted, transcription adds nothing licensable); selection, editorial repair, paragraph numbering and the English working translation: [CC0 1.0](LICENSE-DATA) |
...
| **Plates** | `assets/plates/*.jpg`, `data/plates.json` | images: public domain (faithful reproductions of public-domain 2-D works; sources leaf by leaf in [SOURCES.md](SOURCES.md)); captions and credits: [CC0 1.0](LICENSE-DATA) |
