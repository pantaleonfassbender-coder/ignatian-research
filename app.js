...
const PROGCOLOR = { formula: "#a3873c", paraguay: "#5f8a62", pascal: "#b0687a", monita: "#9a6a9a", dominus: "#7a6a56",
...
const LINIEN = [
  ...
  ["spee", "The conscience of the Society", "Conscience from inside the order, against the order where it failed: Friedrich Spee's Cautio Criminalis against the witch trials and the same conscience singing in the Trutznachtigall; the limpieza dossier — the decree De genere of 1593 with Ribadeneira's thirteen reasons against it; and Molina's examination of the slave trade, with the Society's own slaveholding stated as failure beside the voice."],
...
const TIMELINE = [
  ...
  { id: "servitus", linie: "spee", y: 1594.5, jahr: "1593/1594", kurz: "Molina", href: "#/text/servitus" },
